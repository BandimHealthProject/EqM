...
var adate = promptTypes.input_type.extend({
    ...
    unknownMonth: false,
    unknownYear: false,
    templatePath: '../config/tables/GRAVIDA/forms/GRAVIDA/templates/adate.handlebars',
...
var async_assign = promptTypes.base.extend({
    ...
    debug: false,
    valid: true,
    templatePath: '../config/tables/GRAVIDA/forms/GRAVIDA/templates/async_assign.handlebars',
