...
var adate = promptTypes.input_type.extend({
    ...
    unknownMonth: false,
    unknownYear: false,
    templatePath: '../config/tables/MIF_FAL/forms/MIF_FAL/templates/adate.handlebars',
...
var async_assign = promptTypes.base.extend({
    ...
    debug: false,
    valid: true,
    templatePath: '../config/tables/MIF_FAL/forms/MIF_FAL/templates/async_assign.handlebars',
